...
import { Wallet, LogOut, Network, ChevronDown, Check, Gift } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="hidden sm:inline text-xs font-pixel text-primary/70 uppercase tracking-widest">
              // FHE Encrypted
            </span>
          </div>
